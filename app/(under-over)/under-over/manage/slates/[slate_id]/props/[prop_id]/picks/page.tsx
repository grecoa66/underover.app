...
import { getResultOfPicks } from "@/app/(under-over)/under-over/(public)/slates/[slate_id]/results/actions";
...
const ManagePicksPage = async ({
  ...
  const picks = await getResultOfPicks({ prop_id: Number(params.prop_id) });
